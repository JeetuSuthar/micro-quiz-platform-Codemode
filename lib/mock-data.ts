// Centralized mock data that can be imported directly
...
export interface QuizWithQuestions extends Omit<Quiz, "category"> {
  category: string
  questions: Question[]
}
...
export const quizzes: Record<string, QuizWithQuestions> = {
...
export function getQuizById(id: string): QuizWithQuestions | undefined {
  return quizzes[id]
}
